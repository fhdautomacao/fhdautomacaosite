...
const Hero = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900 md:from-slate-900 md:via-slate-800 md:to-blue-900 from-blue-50 via-blue-100 to-blue-200">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg md:text-xl lg:text-2xl text-blue-100 md:text-blue-100 text-gray-700 leading-relaxed max-w-2xl">
            ...
            <div className="grid grid-cols-3 gap-4 md:gap-8 py-8">
              <div className="text-center">
                <div className="text-2xl md:text-3xl lg:text-4xl font-bold text-white md:text-white text-gray-800 mb-2">25%</div>
                <div className="text-blue-300 md:text-blue-300 text-gray-600 text-xs md:text-sm">Redução de Custos</div>
              </div>
              <div className="text-center">
                <div className="text-2xl md:text-3xl lg:text-4xl font-bold text-white md:text-white text-gray-800 mb-2">30+</div>
                <div className="text-blue-300 md:text-blue-300 text-gray-600 text-xs md:text-sm">Produtos no Catálogo</div>
              </div>
              <div className="text-center">
                <div className="text-2xl md:text-3xl lg:text-4xl font-bold text-white md:text-white text-gray-800 mb-2">10+</div>
            ...
            <div className="space-y-3 md:space-y-4">
              <div className="flex items-center space-x-3 md:space-x-4 group">
                ...
                <span className="text-blue-100 md:text-blue-100 text-gray-700 text-sm md:text-base">Projetos personalizados e sob medida</span>
              </div>
              <div className="flex items-center space-x-3 md:space-x-4 group">
                <div className="bg-green-500/20 p-2 rounded-lg group-hover:bg-green-500/30 transition-colors flex-shrink-0">
                  <CheckCircle className="text-green-400" size={18} />
                </div>
                <span className="text-blue-100 md:text-blue-100 text-gray-700 text-sm md:text-base">Suporte técnico especializado 24/7</span>
              </div>
              <div className="flex items-center space-x-3 md:space-x-4 group">
                <div className="bg-green-500/20 p-2 rounded-lg group-hover:bg-green-500/30 transition-colors flex-shrink-0">
                  <CheckCircle className="text-green-400" size={18} />
                </div>
                <span className="text-blue-100 md:text-blue-100 text-gray-700 text-sm md:text-base">Tecnologia de ponta e inovação constante</span>
              </div>
            </div>
          ...
          <div className="relative mt-8 lg:mt-0">
            {/* Main Card */}
            <div className="relative bg-gradient-to-br from-white/10 to-white/5 md:from-white/10 md:to-white/5 from-white/90 to-white/95 backdrop-blur-lg rounded-3xl p-4 md:p-6 lg:p-8 border border-white/20 md:border-white/20 border-gray-200 shadow-2xl">
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <div className="grid grid-cols-2 gap-3 md:gap-4">
                  <div className="bg-gradient-to-br from-blue-500/20 to-blue-600/20 rounded-xl p-3 md:p-4 border border-blue-400/30">
                    ...
                    <div className="text-white md:text-white text-gray-800 font-semibold text-xs md:text-sm">Experiência</div>
                  ...
                  <div className="bg-gradient-to-br from-yellow-500/20 to-yellow-600/20 rounded-xl p-3 md:p-4 border border-yellow-400/30">
                    ...
                    <div className="text-white md:text-white text-gray-800 font-semibold text-xs md:text-sm">Preço Justo</div>
                  ...
                  <div className="bg-gradient-to-br from-green-500/20 to-green-600/20 rounded-xl p-3 md:p-4 border border-green-400/30">
                    ...
                    <div className="text-white md:text-white text-gray-800 font-semibold text-xs md:text-sm">Qualidade</div>
                  ...
                  <div className="bg-gradient-to-br from-purple-500/20 to-purple-600/20 rounded-xl p-3 md:p-4 border border-purple-400/30">
                    ...
                    <div className="text-white md:text-white text-gray-800 font-semibold text-xs md:text-sm">Atendimento</div>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
        <div className="flex flex-col items-center space-y-2 text-white/60 md:text-white/60 text-gray-600">
          ...
          <div className="w-6 h-10 border-2 border-white/30 md:border-white/30 border-gray-400 rounded-full flex justify-center">
            <div className="w-1 h-3 bg-white/60 md:bg-white/60 bg-gray-600 rounded-full mt-2 animate-bounce"></div>
          </div>
        </div>
      </div>
    </section>
