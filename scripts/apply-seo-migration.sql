-- Script para aplicar a migração de SEO
-- Execute este script no seu banco de dados Supabase

-- 1. Criar a tabela seo_settings
...
CREATE INDEX IF NOT EXISTS idx_seo_settings_page_name ON seo_settings(page_name);
...
-- 4. Inserir dados padrão para páginas principais
...
COMMENT ON TABLE seo_settings IS 'Configurações de SEO para diferentes páginas do site';
COMMENT ON COLUMN seo_settings.page_name IS 'Nome da página (ex: home, about, services)';
COMMENT ON COLUMN seo_settings.title IS 'Título da página (tag title)';
COMMENT ON COLUMN seo_settings.description IS 'Meta description da página';
COMMENT ON COLUMN seo_settings.keywords IS 'Meta keywords da página';
COMMENT ON COLUMN seo_settings.canonical_url IS 'URL canônica da página';
COMMENT ON COLUMN seo_settings.og_title IS 'Título para Open Graph';
COMMENT ON COLUMN seo_settings.og_description IS 'Descrição para Open Graph';
COMMENT ON COLUMN seo_settings.og_image IS 'Imagem para Open Graph';
COMMENT ON COLUMN seo_settings.og_type IS 'Tipo de conteúdo para Open Graph';
COMMENT ON COLUMN seo_settings.og_site_name IS 'Nome do site para Open Graph';
COMMENT ON COLUMN seo_settings.og_locale IS 'Localização para Open Graph';
COMMENT ON COLUMN seo_settings.twitter_card IS 'Tipo de card do Twitter';
COMMENT ON COLUMN seo_settings.twitter_title IS 'Título para Twitter';
COMMENT ON COLUMN seo_settings.twitter_description IS 'Descrição para Twitter';
COMMENT ON COLUMN seo_settings.twitter_image IS 'Imagem para Twitter';
COMMENT ON COLUMN seo_settings.structured_data IS 'Dados estruturados em JSON-LD';
COMMENT ON COLUMN seo_settings.robots IS 'Instruções para robôs de busca';
COMMENT ON COLUMN seo_settings.author IS 'Autor da página';
COMMENT ON COLUMN seo_settings.viewport IS 'Configuração do viewport';
COMMENT ON COLUMN seo_settings.charset IS 'Charset da página';
COMMENT ON COLUMN seo_settings.favicon_url IS 'URL do favicon';
COMMENT ON COLUMN seo_settings.is_active IS 'Se a configuração está ativa';

-- 6. Verificar se a migração foi aplicada com sucesso
SELECT 
